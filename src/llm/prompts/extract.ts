export const EXTRACT_PROMPT_VERSION = '1.0.0';

export const EXTRACT_PROMPT = `You are an expert maritime document analyst with deep knowledge of STCW, MARINA, IMO, and international seafarer certification standards.
